...
Common labels
*/}}
{{- define "mongo-pod-labeler.labels" -}}
helm.sh/chart: {{ include "mongo-pod-labeler.chart" . }}
{{ include "mongo-pod-labeler.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "mongo-pod-labeler.selectorLabels" -}}
...
*/}}
{{- define "mongo-pod-labeler.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "mongo-pod-labeler.fullname" .) .Values.serviceAccount.name }}
{{- else }}
